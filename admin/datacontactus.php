                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">DataContactUs</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    <?php while ($data = mysqli_fetch_assoc($result)) : ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo $data['nama_cu']; ?></td>
                                            <td><?php echo $data['email_cu']; ?></td>
                                            <td><?php echo $data['subject_cu']; ?></td>
                                            <td><?php echo $data['pesan_cu']; ?></td>
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="hapuscontactus.php?id=<?php echo $data['id_cu']; ?>"><button class="btn btn-danger" onclick="return confirm('Hapus?');">Hapus</button></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
